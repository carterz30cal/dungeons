...
public class RuneGreaterHealing extends AbsAbility 
{

	@Override
	public ArrayList<String> description() {
		ArrayList<String> d = new ArrayList<String>();
		d.add(rune + "Greater Healing");
		d.add("Regain 1.2% of your max health every hit.");
		return d;
	}
	...
	public int onAttack(DungeonsPlayer d,DMob dMob,int damage) 
	{
		...
		{
			laser.add(dx, dy, dz);
			Dungeons.w.spawnParticle(Particle.REDSTONE, laser, 2, 0d, 0d, 0d, new DustOptions(Color.GREEN,0.6f));
		}
		d.heal(0.012);
		return damage;
	} 
